      ...
      >
        <div className="flex justify-between md:justify-center items-center w-full md:gap-4 lg:gap-[30px] xl:gap-[40px]">
          ...
          <div className="w-[60px] sm:w-[80px] md:w-[100px] lg:w-[180px] xl:w-[220px] flex flex-col items-center justify-center ">
            ...
            <div className="font-tactic_sans text-[10px] sm:text-sm md:text-base lg:text-[24px] xl:text-[29px] text-custom-white leading-none  tracking-widest text-center">
              DAYS
            </div>
          </div>
          ...
          <div className="w-[60px] sm:w-[80px] md:w-[100px] lg:w-[180px] xl:w-[220px] flex flex-col items-center justify-center">
            ...
            <div className="font-tactic_sans text-[10px] sm:text-sm md:text-base lg:text-[24px] xl:text-[29px] text-custom-white leading-none mt-2 lg:mt-6 tracking-widest text-center">
              HOURS
            </div>
          </div>
